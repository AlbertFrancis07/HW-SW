...
my @all_semantic_names = qw(
	...
	TIE_semantic_slot2_st_reg8x16
	TIE_semantic_slot0_st_reg8x16
	TIE_semantic_slot2_ld_reg8x16
	TIE_semantic_slot0_ld_reg8x16
	TIE_semantic_slot2_mv_reg8x16
	TIE_semantic_slot0_mv_reg8x16
	TIE_semantic_slot0_RUR_REG_K
	TIE_semantic_slot0_WUR_REG_K
	TIE_semantic_slot0_BIT_REVERSE
	TIE_semantic_slot0_DIT_FIRST_STAGE
	TIE_semantic_slot0_DIT_SECOND_STAGE
	TIE_semantic_slot0_DIT_THIRD_STAGE
	TIE_semantic_slot0_DIT_CALC_STAGE
	TIE_semantic_slot0_DIF_FIRST_STAGE
	TIE_semantic_slot0_DIF_SECOND_STAGE
	TIE_semantic_slot0_DIF_LAST_STAGE
	TIE_semantic_slot0_DIF_CALC_STAGE
	TIE_semantic_slot0_SHIFT_CONDITION
	TIE_semantic_slot2_SIMD_LOAD
	TIE_semantic_slot0_SIMD_LOAD
	TIE_semantic_slot0_SIMD_STORE
	TIE_semantic_slot2_SIMD_LOAD_SHUFFLED
	TIE_semantic_slot0_SIMD_LOAD_SHUFFLED
	TIE_semantic_slot0_SIMD_STORE_SHUFFLED
	TIE_semantic_slot0_SIMD_LOAD_INTERLEAVED
	TIE_semantic_slot0_SIMD_STORE_INTERLEAVED
);
