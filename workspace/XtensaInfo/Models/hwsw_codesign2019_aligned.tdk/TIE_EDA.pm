...
my @all_semantic_names = qw(
	...
	TIE_semantic_slot2_xt_sem_loads_stores
	...
	TIE_semantic_slot2_st_vect8x16
	TIE_semantic_slot0_st_vect8x16
	TIE_semantic_slot2_ld_vect8x16
	TIE_semantic_slot0_ld_vect8x16
	TIE_semantic_slot2_mv_vect8x16
	TIE_semantic_slot0_mv_vect8x16
	TIE_semantic_slot0_RUR_REG_K
	TIE_semantic_slot0_WUR_REG_K
	TIE_semantic_slot0_FFT_REVERSE_BITS
	TIE_semantic_slot0_FFT_DIT_CALC_FIRST_STAGE
	TIE_semantic_slot0_FFT_DIT_CALC_SECOND_STAGE
	TIE_semantic_slot0_FFT_DIT_CALC_THIRD_STAGE
	TIE_semantic_slot0_FFT_DIF_CALC_THIRD_LAST_STAGE
	TIE_semantic_slot0_FFT_DIF_CALC_SECOND_LAST_STAGE
	TIE_semantic_slot0_FFT_DIF_CALC_LAST_STAGE
	TIE_semantic_slot0_FFT_DIT_CALC_STAGE
	TIE_semantic_slot0_FFT_DIF_CALC_STAGE
	TIE_semantic_slot0_FFT_CHECK_SHIFT_CONDITION
	TIE_semantic_slot2_FFT_SIMD_LOAD_SHUFFLED
	TIE_semantic_slot0_FFT_SIMD_LOAD_SHUFFLED
	TIE_semantic_slot0_FFT_SIMD_STORE_SHUFFLED
	TIE_semantic_slot2_FFT_SIMD_LOAD
	TIE_semantic_slot0_FFT_SIMD_LOAD
	TIE_semantic_slot0_FFT_SIMD_STORE
	TIE_semantic_slot0_FFT_SIMD_LOAD_INTERLEAVED
	TIE_semantic_slot0_FFT_SIMD_STORE_INTERLEAVED
);
