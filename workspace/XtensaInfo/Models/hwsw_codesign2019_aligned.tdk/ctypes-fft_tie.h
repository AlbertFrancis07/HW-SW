...
#ifndef CSTUB_fft_tie_HEADER
#define CSTUB_fft_tie_HEADER
...
#define CSTUB_(X) cstub_Xm_hwsw_codesign2019_aligned_##X

/* Ctypes convertion tables */

#define CSTUB_NUM_CTYPES   19
